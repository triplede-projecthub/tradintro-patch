...
import { MarketRepository, NotificationsRepository, UserRepository } from '../repositories';
...
export declare class NotificationService {
    ...
    private utilService;
    constructor(notificationsRepository: NotificationsRepository, marketListRepository: MarketRepository, userRepository: UserRepository, utilService: UtilService);
    ...
    generateNotificationQuery(notification_type: number[], notification_status: number[], alert_popup_status: number[], notification_user_id: number, offset?: number, limit?: number, userLevel?: number, searchQuery?: string, stockId?: number): string;
