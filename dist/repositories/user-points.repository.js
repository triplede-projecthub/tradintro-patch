...
let UserPointsRepository = class UserPointsRepository extends repository_1.DefaultCrudRepository {
    constructor(dataSource) {
        super(models_1.UserPoints, dataSource);
    }
};
UserPointsRepository = tslib_1.__decorate([
